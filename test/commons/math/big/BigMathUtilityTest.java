...
public class BigMathUtilityTest {
     ...
     * @see BigMathUtility#TEN
     * @see BigMathUtility#ONE_HUNDRED
     * @see BigMathUtility#ONE_THOUSAND
     */
    @Test
    public void testConstants() throws Exception {
        ...
        Assert.assertEquals(BigDecimal.valueOf(10), BigMathUtility.TEN);
        Assert.assertEquals(BigDecimal.valueOf(100), BigMathUtility.ONE_HUNDRED);
        Assert.assertEquals(BigDecimal.valueOf(1000), BigMathUtility.ONE_THOUSAND);
    }
    ...
    public void testPower() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("673316599491770128906526915476100771794417410780749.6323339009051411530625125585849849592487451775943659571939043426"), BigMathUtility.power(new BigDecimal("9.841123"), new BigDecimal("51.184223")));
        Assert.assertEquals(new BigDecimal("2.155916908314036E-49"), BigMathUtility.power(new BigDecimal("9"), new BigDecimal("-51")));
    ...
    public void testRoot() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("786013.743768254270833882303879116136981964490156798758108407658146822"),
                BigMathUtility.root(new BigDecimal("485613128980565211.60898418142984980484918454928718798489728798"), new BigDecimal("3")));
        Assert.assertEquals(new BigDecimal(".8797086075973767519068093447977901303826693684151996747933700452"),
                BigMathUtility.root(new BigDecimal("0.0000000578"), new BigDecimal("-.00941")));
        ...
        Assert.assertEquals(new BigDecimal(".8797086075973767519068093447977901303826693684151996747933700452"), BigMathUtility.root(new BigDecimal(".0000000578"), new BigDecimal("-.00941")));
    ...
    public void testSqrt() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("1408566466962021869.0127349699943764140819920917866950425361447066125981115756352251"), BigMathUtility.sqrt(new BigDecimal("1984059491849872645425452087817945451.185908484125974894141541")));
    ...
    public void testLog() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("51.4372649403029813971127507109192339983014045530619734442644483616"), BigMathUtility.log(new BigDecimal("897646410054048148429841842848065468.0849817826849832454984"), 5));
    ...
    public void testLog10() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("35.9531052983565229550666849438660017416167932565920217005105313809"), BigMathUtility.log10(new BigDecimal("897646410054048148429841842848065468.0849817826849832454984")));
    ...
    public void testLog2() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("119.4336305890542175633703859022802534717567830775870122829617446884"), BigMathUtility.log2(new BigDecimal("897646410054048148429841842848065468.0849817826849832454984")));
    ...
    public void testLn() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("82.7850843068409710061680172190752326331853971152562735574815381239"), BigMathUtility.ln(new BigDecimal("897646410054048148429841842848065468.0849817826849832454984")));
    ...
    public void testExp() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("87652482559058384867898537124044922325997153244135452151780861343144658710465992236921743054335794223587689153471025357788596255420511085825460468811868290364245791857017367334570705261411551194318979977100012.8404004491039759569464177641362925271313236687731948056722009908"), BigMathUtility.exp(new BigDecimal("481.108494184282465154519")));
    ...
    public void testReciprocal() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("0.000065875936319237801749576983044329762896146385608832657533651"), BigMathUtility.reciprocal(new BigDecimal("15180.049891874845498498428248984")));
        Assert.assertEquals(new BigDecimal("2004334379.2886651634556187315535266092583612792306845887817197112665553011"), BigMathUtility.reciprocal(new BigDecimal("0.00000000049891874845498498428248984")));
    ...
    public void testRound() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("0"), BigMathUtility.round(new BigDecimal(".4154211")));
        Assert.assertEquals(new BigDecimal("1"), BigMathUtility.round(new BigDecimal(".94108")));
        Assert.assertEquals(new BigDecimal("0"), BigMathUtility.round(new BigDecimal(".00033")));
        Assert.assertEquals(new BigDecimal("0"), BigMathUtility.round(new BigDecimal(".421654")));
        Assert.assertEquals(new BigDecimal("1"), BigMathUtility.round(new BigDecimal("1.4154211")));
        Assert.assertEquals(new BigDecimal("9"), BigMathUtility.round(new BigDecimal("8.94108")));
        Assert.assertEquals(new BigDecimal("33"), BigMathUtility.round(new BigDecimal("33.00033")));
        Assert.assertEquals(new BigDecimal("54"), BigMathUtility.round(new BigDecimal("54.421654")));
        Assert.assertEquals(new BigDecimal("840000000000000000000000000000000000000000"), BigMathUtility.round(new BigDecimal("840000000000000000000000000000000000000000")));
        Assert.assertEquals(new BigDecimal("0"), BigMathUtility.round(new BigDecimal("0.0000000000000000000000000000000000000084")));
        Assert.assertEquals(new BigDecimal("874560984810495456040984654132198077871049809840598711111771980"), BigMathUtility.round(new BigDecimal("874560984810495456040984654132198077871049809840598711111771980.000158979806579154563234089338737573040498108453021219870845654655086888484521260098")));
        ...
        Assert.assertEquals(
                new BigDecimal("154."),
                BigMathUtility.round(n, BigMathUtility.PrecisionMode.MAX_PRECISION));
        Assert.assertEquals(
                new BigDecimal("154."),
    ...
    public void testAbs() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("840000000000000000000000000000000000000000"), BigMathUtility.abs(new BigDecimal("840000000000000000000000000000000000000000")));
        ...
        Assert.assertEquals(new BigDecimal("874560984810495456040984654132198077871049809840598711111771980.000158979806579154563234089338737573040498108453021219870845654655086888484521260098"), BigMathUtility.abs(new BigDecimal("874560984810495456040984654132198077871049809840598711111771980.000158979806579154563234089338737573040498108453021219870845654655086888484521260098")));
        ...
        n = new BigDecimal("154.");
        Assert.assertEquals(
                new BigDecimal("154."),
    ...
    public void testNegate() throws Exception {
        ...
        Assert.assertEquals(new BigDecimal("-840000000000000000000000000000000000000000"), BigMathUtility.negate(new BigDecimal("840000000000000000000000000000000000000000")));
    ...
    public void testEqualTo() throws Exception {
        ...
        Assert.assertTrue(BigMathUtility.equalTo(
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"),
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"))
        );
        Assert.assertFalse(BigMathUtility.equalTo(
    ...
    public void testNotEqualTo() throws Exception {
        //standard
        Assert.assertFalse(BigMathUtility.notEqualTo(new BigDecimal("1"), new BigDecimal("1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("17"), new BigDecimal("4")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("9"), new BigDecimal("177")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("0"), new BigDecimal("88")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("0549"), new BigDecimal("0")));
        
        //negative
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("-1"), new BigDecimal("1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("-17"), new BigDecimal("4")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("-9"), new BigDecimal("177")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("-0"), new BigDecimal("88")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("-0549"), new BigDecimal("0")));
        ...
        //decimal
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("1"), new BigDecimal(".1")));
        Assert.assertFalse(BigMathUtility.notEqualTo(new BigDecimal(".1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("3.1"), new BigDecimal("1.9")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("3.1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("03.1"), new BigDecimal("20.1")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal(".578"), new BigDecimal(".941")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("0.578"), new BigDecimal("984.941")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal(".0000000578"), new BigDecimal(".00941")));
        Assert.assertTrue(BigMathUtility.notEqualTo(new BigDecimal("18.0000000578"), new BigDecimal("2.00941")));
        ...
        //larger cases
        Assert.assertTrue(BigMathUtility.notEqualTo(
                new BigDecimal("15649826500097987154602319879456339009444871265"),
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"))
        );
        Assert.assertTrue(BigMathUtility.notEqualTo(
        ...
        Assert.assertFalse(BigMathUtility.notEqualTo(
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"),
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"))
        );
        Assert.assertTrue(BigMathUtility.notEqualTo(
        ...
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.notEqualTo(new BigDecimal("1"), null));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.notEqualTo(null, new BigDecimal("1")));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.notEqualTo(null, null));
        
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.notEqualTo(new BigDecimal("1"), new BigDecimal("15s5")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.notEqualTo(new BigDecimal("15s5"), new BigDecimal("1")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.notEqualTo(new BigDecimal("15s5"), new BigDecimal("a")));
    }
    
    /**
     * JUnit test of greaterThanOrEqualTo.
     *
     * @throws Exception When there is an exception.
    ...
    public void testGreaterThanOrEqualTo() throws Exception {
        //standard
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("17"), new BigDecimal("4")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("9"), new BigDecimal("177")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0"), new BigDecimal("88")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0549"), new BigDecimal("0")));
        
        //negative
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-17"), new BigDecimal("4")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-9"), new BigDecimal("177")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-0"), new BigDecimal("88")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-0549"), new BigDecimal("0")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("17"), new BigDecimal("-4")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("9"), new BigDecimal("-177")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0"), new BigDecimal("-88")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0549"), new BigDecimal("-0")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-17"), new BigDecimal("-4")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-9"), new BigDecimal("-177")));
        ...
        //decimal
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("1.9")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("0.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("03.1"), new BigDecimal("20.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".578"), new BigDecimal(".941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0.578"), new BigDecimal("984.941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".0000000578"), new BigDecimal(".00941")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("18.0000000578"), new BigDecimal("2.00941")));
        
        //decimal, negative
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("0.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal(".1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-.1"), new BigDecimal(".1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-3.1"), new BigDecimal("1.9")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-3.1"), new BigDecimal("0.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-03.1"), new BigDecimal("20.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-.578"), new BigDecimal(".941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-0.578"), new BigDecimal("984.941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-.0000000578"), new BigDecimal(".00941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-18.0000000578"), new BigDecimal("2.00941")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-0.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".1"), new BigDecimal("-.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("-1.9")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("-0.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("03.1"), new BigDecimal("-20.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".578"), new BigDecimal("-.941")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("0.578"), new BigDecimal("-984.941")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal(".0000000578"), new BigDecimal("-.00941")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("18.0000000578"), new BigDecimal("-2.00941")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-0.1")));
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-.1")));
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(new BigDecimal("-.1"), new BigDecimal("-.1")));
        ...
        //larger cases
        Assert.assertFalse(BigMathUtility.greaterThanOrEqualTo(
                new BigDecimal("15649826500097987154602319879456339009444871265"),
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"))
        );
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"),
                new BigDecimal("15649826500097987154602319879456339009444871265"))
        );
        Assert.assertTrue(BigMathUtility.greaterThanOrEqualTo(
        ...
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), null));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.greaterThanOrEqualTo(null, new BigDecimal("1")));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.greaterThanOrEqualTo(null, null));
        
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.greaterThanOrEqualTo(new BigDecimal("1"), new BigDecimal("15s5")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.greaterThanOrEqualTo(new BigDecimal("15s5"), new BigDecimal("1")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.greaterThanOrEqualTo(new BigDecimal("15s5"), new BigDecimal("a")));
    }
    
    /**
     * JUnit test of lessThanOrEqualTo.
     *
     * @throws Exception When there is an exception.
    ...
    public void testLessThanOrEqualTo() throws Exception {
        //standard
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("17"), new BigDecimal("4")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("9"), new BigDecimal("177")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0"), new BigDecimal("88")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0549"), new BigDecimal("0")));
        
        //negative
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-17"), new BigDecimal("4")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-9"), new BigDecimal("177")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-0"), new BigDecimal("88")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-0549"), new BigDecimal("0")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("17"), new BigDecimal("-4")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("9"), new BigDecimal("-177")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0"), new BigDecimal("-88")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0549"), new BigDecimal("-0")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-17"), new BigDecimal("-4")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-9"), new BigDecimal("-177")));
        ...
        //decimal
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("0.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".1"), new BigDecimal(".1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("1.9")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("03.1"), new BigDecimal("20.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".578"), new BigDecimal(".941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0.578"), new BigDecimal("984.941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".0000000578"), new BigDecimal(".00941")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("18.0000000578"), new BigDecimal("2.00941")));
        
        //decimal, negative
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-.1"), new BigDecimal(".1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-3.1"), new BigDecimal("1.9")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-3.1"), new BigDecimal("0.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-03.1"), new BigDecimal("20.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-.578"), new BigDecimal(".941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-0.578"), new BigDecimal("984.941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-.0000000578"), new BigDecimal(".00941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-18.0000000578"), new BigDecimal("2.00941")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-0.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("-.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".1"), new BigDecimal("-.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("-1.9")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("3.1"), new BigDecimal("-0.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("03.1"), new BigDecimal("-20.1")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".578"), new BigDecimal("-.941")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("0.578"), new BigDecimal("-984.941")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal(".0000000578"), new BigDecimal("-.00941")));
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(new BigDecimal("18.0000000578"), new BigDecimal("-2.00941")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-0.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-1"), new BigDecimal("-.1")));
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(new BigDecimal("-.1"), new BigDecimal("-.1")));
        ...
        //larger cases
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(
                new BigDecimal("15649826500097987154602319879456339009444871265"),
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"))
        );
        Assert.assertFalse(BigMathUtility.lessThanOrEqualTo(
                new BigDecimal("5967945689778787050698789841534979848487446456313280987564"),
                new BigDecimal("15649826500097987154602319879456339009444871265"))
        );
        Assert.assertTrue(BigMathUtility.lessThanOrEqualTo(
        ...
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), null));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.lessThanOrEqualTo(null, new BigDecimal("1")));
        TestUtils.assertException(NullPointerException.class, () ->
                BigMathUtility.lessThanOrEqualTo(null, null));
        
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.lessThanOrEqualTo(new BigDecimal("1"), new BigDecimal("15s5")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.lessThanOrEqualTo(new BigDecimal("15s5"), new BigDecimal("1")));
        TestUtils.assertException(NumberFormatException.class, "Character s is neither a decimal digit number, decimal point, nor \"e\" notation exponential mark.", () ->
                BigMathUtility.lessThanOrEqualTo(new BigDecimal("15s5"), new BigDecimal("a")));
    }
