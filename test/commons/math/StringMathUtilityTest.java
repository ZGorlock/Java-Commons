...
public class StringMathUtilityTest {
    ...
    public void testRound() throws Exception {
        ...
        Assert.assertEquals("0.4154211", StringMathUtility.round(".4154211"));
        Assert.assertEquals("0.94108", StringMathUtility.round(".94108"));
        Assert.assertEquals("0.00033", StringMathUtility.round(".00033"));
        Assert.assertEquals("0.421654", StringMathUtility.round(".421654"));
        Assert.assertEquals("1.4154211", StringMathUtility.round("1.4154211"));
        Assert.assertEquals("8.94108", StringMathUtility.round("8.94108"));
        Assert.assertEquals("33.00033", StringMathUtility.round("33.00033"));
        Assert.assertEquals("54.421654", StringMathUtility.round("54.421654"));
        ...
        Assert.assertEquals("0.0000000000000000000000000000000000000084", StringMathUtility.round("0.0000000000000000000000000000000000000084"));
        Assert.assertEquals("874560984810495456040984654132198077871049809840598711111771980.0001589798065791545632340893387375730404981084530212198708456547", StringMathUtility.round("874560984810495456040984654132198077871049809840598711111771980.000158979806579154563234089338737573040498108453021219870845654655086888484521260098"));
        ...
        Assert.assertEquals(
                "154.489106216501268508561041049840985415420109512040808484877065321",
        ...
        Assert.assertEquals(
                "154.",
                StringMathUtility.round(n, BigMathUtility.PrecisionMode.MAX_PRECISION));
        Assert.assertEquals(
                "154.",
    ...
    public void testNegate() throws Exception {
        ...
        Assert.assertEquals("-874560984810495456040984654132198077871049809840598711111771980.0001589798065791545632340893387375730404981084530212198708456547", StringMathUtility.negate("874560984810495456040984654132198077871049809840598711111771980.000158979806579154563234089338737573040498108453021219870845654655086888484521260098"));
