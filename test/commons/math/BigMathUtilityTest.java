...
public class BigMathUtilityTest {
    ...
    public void testPi() throws Exception {
        //standard
        Assert.assertEquals("3.141592653589793238462643383279502884197169399375105820974944592", BigMathUtility.pi());
        
        //precision
        Assert.assertEquals("3.141592653589793238462643383279502884197169399375105820974944592", BigMathUtility.pi(BigMathUtility.PrecisionMode.DEFAULT_PRECISION));
        Assert.assertEquals("3", BigMathUtility.pi(BigMathUtility.PrecisionMode.NO_PRECISION));
        Assert.assertEquals("3.1415927", BigMathUtility.pi(BigMathUtility.PrecisionMode.LOW_PRECISION));
        Assert.assertEquals("3.141592653589793", BigMathUtility.pi(BigMathUtility.PrecisionMode.MID_PRECISION));
        Assert.assertEquals("3.141592653589793238462643383279502884197169399375105820974944592", BigMathUtility.pi(BigMathUtility.PrecisionMode.HIGH_PRECISION));
        ...
        //custom precision
        Assert.assertEquals("3.14159265358979", BigMathUtility.pi(15));
        Assert.assertEquals("3.141592653590", BigMathUtility.pi(13));
        Assert.assertEquals("3.14159265359", BigMathUtility.pi(12));
        Assert.assertEquals("3.141592654", BigMathUtility.pi(10));
        Assert.assertEquals("3.14159265", BigMathUtility.pi(9));
        Assert.assertEquals("3.14159", BigMathUtility.pi(6));
        Assert.assertEquals("3.14", BigMathUtility.pi(3));
        Assert.assertEquals("3.1", BigMathUtility.pi(2));
        Assert.assertEquals("3", BigMathUtility.pi(1));
    }
