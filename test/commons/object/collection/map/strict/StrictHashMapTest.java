...
/**
 * JUnit test of StrictHashMap.
 *
 * @see StrictHashMap
 */
@SuppressWarnings({"RedundantSuppression", "ConstantConditions", "ResultOfMethodCallIgnored", "unchecked", "SpellCheckingInspection"})
@RunWith(PowerMockRunner.class)
@PrepareForTest({StrictHashMap.class})
public class StrictHashMapTest {
     ...
     * The logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(StrictHashMapTest.class);
     ...
     */
    private StrictHashMap<String, Integer> sut;
    ...
    public void setup() throws Exception {
        sut = new StrictHashMap<>(MapUtility.mapOf(testKeys, testValues));
    }
     ...
     *
     * @throws Exception When there is an exception.
     * @see StrictHashMap#StrictHashMap(Map)
     * @see StrictHashMap#StrictHashMap()
     */
    @Test
    public void testConstructors() throws Exception {
        final Map<String, Integer> sourceMap = MapUtility.mapOf(testKeys, testValues);
        StrictHashMap<String, Integer> map1;
        StrictHashMap<String, Integer> map2;
        
        //map
        map1 = new StrictHashMap<>(sourceMap);
        Assert.assertNotNull(map1);
        Assert.assertTrue(map1 instanceof HashMap);
        TestUtils.assertMapEquals(map1, sourceMap);
        
        //empty
        map2 = new StrictHashMap<>();
     ...
     *
     * @throws Exception When there is an exception.
     * @see StrictHashMap#exposedEntrySet()
     */
    @Test
    public void testExposedEntrySet() throws Exception {
        ...
        TestUtils.assertListEquals(
                ...
                sut.exposedEntrySet(), false);
        Assert.assertSame(sut.exposedEntrySet(), sut.exposedEntrySet());
        
        //empty
        Assert.assertTrue(new StrictHashMap<>().exposedEntrySet().isEmpty());
    }
    ...
    public void testEntrySet() throws Exception {
        ...
        //empty
        Assert.assertTrue(new StrictHashMap<>().entrySet().isEmpty());
    }
     ...
     *
     * @throws Exception When there is an exception.
     * @see StrictHashMap#exposedKeySet()
     */
    @Test
    public void testExposedKeySet() throws Exception {
        ...
        TestUtils.assertListEquals(
                ...
                sut.exposedKeySet(), false);
        Assert.assertSame(sut.exposedKeySet(), sut.exposedKeySet());
        
        //empty
        Assert.assertTrue(new StrictHashMap<>().exposedKeySet().isEmpty());
    }
    ...
    public void testKeySet() throws Exception {
        ...
        //empty
        Assert.assertTrue(new StrictHashMap<>().keySet().isEmpty());
    }
     ...
     *
     * @throws Exception When there is an exception.
     * @see StrictHashMap#exposedValues()
     */
    @Test
    public void testExposedValues() throws Exception {
        ...
        TestUtils.assertListEquals(
                ...
                sut.exposedValues(), false);
        Assert.assertSame(sut.exposedValues(), sut.exposedValues());
        
        //empty
        Assert.assertTrue(new StrictHashMap<>().exposedValues().isEmpty());
    }
    ...
    public void testValues() throws Exception {
        ...
        //empty
        Assert.assertTrue(new StrictHashMap<>().values().isEmpty());
    }
