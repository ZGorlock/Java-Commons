...
public class FileTransferInterceptorTest {
    ...
    public void testAroundReadFrom() throws Exception {
        ...
        Mockito.doAnswer(invocationOnMock -> {
            ...
            ProgressBar progressBar = TestAccess.getFieldValue(progressBarInputStream, ProgressBar.class, "progressBar");
    ...
    public void testAroundWriteTo() throws Exception {
        ...
        Mockito.doAnswer(invocationOnMock -> {
            ...
            ProgressBar progressBar = TestAccess.getFieldValue(progressBarOutputStream, ProgressBar.class, "progressBar");
            Assert.assertEquals("test.txt", progressBar.getTitle());
